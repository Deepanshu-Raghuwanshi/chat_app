...
export type ConversationParticipant = chatComponents['schemas']['ConversationParticipant'];
export type ConversationListResponse = chatComponents['schemas']['ConversationListResponse'];
export type Message = chatComponents['schemas']['Message'];
export type MessageListResponse = chatComponents['schemas']['MessageListResponse'];
export type CreateConversationDto = chatComponents['schemas']['CreateConversationDto'];
