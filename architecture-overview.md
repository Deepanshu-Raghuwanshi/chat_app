...
- **Centralized Configuration**: All environment variables are managed in a single root `.env` file to ensure consistency across microservices and simplify infrastructure management.
